  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (location.pathname === "/items") {
        if (ids) {
          const res = await ItemServices.deleteManyItems({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
      ...
      if (location.pathname === "/supplierrev") {
        if (id) {
      ...
      if (location.pathname === "/product") {
        if (id) {
          const res = await ProductItemServices.deleteProductItem(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setTimeout(() => {
      ...
      if (location.pathname === "/productionrev") {
        if (id) {
          const res = await ProductionServices.deleteProduction(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setTimeout(() => {
            window.location.reload();
      ...
      if (location.pathname === "/purchasesrev") {
        if (id) {
          const res = await PurchasesServices.deletePurchase(id);
          setIsUpdate(true);
          notifySuccess(res.message);
